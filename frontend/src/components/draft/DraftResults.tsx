    ...
    <div className="max-w-5xl mx-auto px-3 sm:px-4 py-4 sm:py-8">
      ...
      <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-center gap-2">
        ...
        <button
          ...
          className="inline-flex items-center justify-center gap-1.5 bg-white/10 hover:bg-white/20 dark:text-white text-gray-900 font-bold text-sm px-4 py-2 rounded-lg border border-gray-700 dark:border-white/10 transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-white/40"
        >
          <History size={14} />
          My Drafts
          {drafts.length > 0 && (
